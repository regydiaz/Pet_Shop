...
public class RadioEspecieController implements ActionListener {
	...
	public RadioEspecieController(JTextField txID, JTextField textField, JTextField textField_1, 
			JLabel lblId, JLabel txtNomePet, JLabel lblNomeDono, JLabel lblEspcie,
			JRadioButton rdbtnIncluir, JRadioButton rdbtnAlterar, JRadioButton rdbtnExcluir, JButton btnEnviar,
			JComboBox<EspecieModel> comboBox) {
